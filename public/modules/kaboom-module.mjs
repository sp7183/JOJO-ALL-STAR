var kaboom = (() => {
  ...
  var jt = (i, t, l) =>
      t in i
        ? Ve(i, t, { enumerable: !0, configurable: !0, writable: !0, value: l })
        : (i[t] = l),
    P = (i, t) => {
      for (var l in t || (t = {})) sr.call(t, l) && jt(i, l, t[l]);
      if (ir) for (var l of ir(t)) Zi.call(t, l) && jt(i, l, t[l]);
      return i;
    },
    D = (i, t) => Hi(i, Ji(t)),
    es = (i) => Ve(i, "__esModule", { value: !0 }),
      ...
      if ((t && typeof t == "object") || typeof t == "function")
        for (let U of Qi(t))
          !sr.call(i, U) &&
            ...
            Ve(i, U, {
              get: () => t[U],
              enumerable: !(w = zi(t, U)) || w.enumerable,
            });
      return i;
    };
  var rs = (
    (i) => (t, l) =>
      (i && i.get(t)) || ((l = ns(es({}), t, 1)), i && i.set(t, l), l)
  ...
  function j(i, t) {
    hr.has(i) ||
      (hr.add(i), console.warn(`${i} is deprecated. Use ${t} instead.`));
  }
  a(j, "deprecateMsg");
  var T = a(
    (i, t, l) =>
  ...
  var B = class {
      ...
      lerp(t, l) {
        return new B(Fe(this.x, t.x, l), Fe(this.y, t.y, l));
      }
      toFixed(t) {
  ...
  a(ke, "Vec3");
  var ce = a((i, t, l) => new ke(i, t, l), "vec3"),
    de = class {
      constructor(t, l, w) {
        b(this, "r", 255);
        b(this, "g", 255);
  ...
  var R = class {
    ...
    invert() {
      let t = [],
        ...
        N = this.m[5] * this.m[14] - this.m[13] * this.m[6],
  ...
  var is = 1103515245,
    ...
    be = class {
      ...
      gen(...t) {
        if (t.length === 0)
          return (this.seed = (is * this.seed + ss) % mr), this.seed / mr;
        if (t.length === 1) {
  ...
  a(be, "RNG");
  var Ht = new be(Date.now());
  function wr(i) {
    return j("rng()", "new RNG()"), new be(i);
  }
  a(wr, "rng");
  function gr(i) {
    return i != null && (Ht.seed = i), Ht.seed;
  }
  a(gr, "randSeed");
  function Ge(...i) {
    return Ht.gen(...i);
  ...
  function ft(i, t) {
    return ae(i, t.p1) || ae(i, t.p2)
      ? !0
      : !!le(t, new he(i.p1, f(i.p2.x, i.p1.y))) ||
          !!le(t, new he(f(i.p2.x, i.p1.y), i.p2)) ||
          !!le(t, new he(i.p2, f(i.p1.x, i.p2.y))) ||
          !!le(t, new he(f(i.p1.x, i.p2.y), i.p1));
  }
  a(ft, "testRectLine");
  function ae(i, t) {
...
`,
    Ts = new Set(["id", "require"]),
    Ss = new Set(["add", "load", "update", "draw", "destroy", "inspect"]);
  function Gr(i) {
  ...
  var Ms = a((i = {}) => {
    let t = (() => {
        ...
        i.crisp &&
          (c.push("image-rendering: pixelated"),
          c.push("image-rendering: crisp-edges")),
          (n.style = c.join(";")),
          n.setAttribute("tabindex", "0");
        let u = n.getContext("webgl", {
          antialias: !0,
          depth: !0,
          stencil: !0,
          alpha: !0,
      ...
      l = (() => {
        ...
        let e = t.gl,
          ...
          c = (d = i.background) != null ? d : E(0, 0, 0);
        if (i.background) {
    ...
    let w = (() => {
      ...
      p = {
        ...
        scenes: {},
        logs: [],
        cam: { pos: at(), scale: f(1), angle: 0, shake: 0, transform: new R() },
      };
    function S(e) {
      return (
        U.numLoading++,
    ...
    function N(e) {
      ...
      return (
        ...
        new Promise((r, c) => {
          (n.onload = () => r(n)),
            (n.onerror = () => c(`Failed to load image from "${e}"`));
        })
      );
    }
    a(N, "loadImg");
    function X(e, n, r, c, u = {}) {
      return S(
        N(n).then((s) => {
          var d;
          let o = jr(He(s, u), r, c, (d = u.chars) != null ? d : Or);
    ...
    function ve(e = 1, n = 1, r = 0, c = 0, u = 1, s = 1) {
      let o = [],
        ...
        h = s / n;
      for (let m = 0; m < n; m++)
        for (let g = 0; g < e; g++) o.push(new k(r + g * d, c + m * h, d, h));
      return o;
    }
    a(ve, "slice");
    function Ee(e, n) {
    ...
    function Te(e, n, r = {}) {
      let c = He(n, r),
        u = ve(r.sliceX || 1, r.sliceY || 1),
        s = { tex: c, frames: u, anims: r.anims || {} };
    ...
    function J(e, n, r = { sliceX: 1, sliceY: 1, anims: {} }) {
      return S(
        new Promise((c, u) => {
          if (!n) return u(`Expected sprite src for "${e}"`);
          typeof n == "string"
            ? N(n)
                .then((s) => c(Te(e, s, r)))
                .catch(u)
          ...
          V(n)
            ...
            .then((u) =>
              or(this, null, function* () {
                let s = yield Promise.all(u.frames.map(N)),
    ...
    function Ce(e, n) {
      return S(
        new Promise((r, c) => {
          if (!n) return c(`expected sound src for "${e}"`);
          typeof n == "string" &&
            V(n)
              .then((u) => u.arrayBuffer())
              .then(
                (u) => new Promise((s, o) => w.ctx.decodeAudioData(u, s, o))
              )
              .then((u) => {
                let s = { buf: u };
                e && (U.sounds[e] = s), r(s);
    ...
    a(Nr, "volume");
    function Ke(e, n = { loop: !1, volume: 1, speed: 1, detune: 0, seek: 0 }) {
      var g;
      if (typeof e == "string") {
        let y = Ke({ buf: _r() });
        return (
        ...
        m = {
          ...
          play(y) {
            ...
            (u = r.createBufferSource()),
              (u.buffer = x.buffer),
              (u.loop = x.loop),
              (u.playbackRate.value = x.playbackRate.value),
              u.detune && (u.detune.value = x.detune.value),
              u.connect(s);
            let W = y != null ? y : this.time();
            u.start(0, W), (d = r.currentTime - W), (c = !1), (h = null);
          },
          pause() {
            c || (u.stop(), (c = !0), (h = r.currentTime));
          },
          isPaused() {
            return c;
          },
          ...
          speed(y) {
            return (
              y !== void 0 && (u.playbackRate.value = z(y, gs, Us)),
              u.playbackRate.value
            );
          },
          detune(y) {
            return u.detune
              ? (y !== void 0 && (u.detune.value = z(y, ys, bs)),
                u.detune.value)
              : 0;
          },
          volume(y) {
    ...
    function ln(e = on, n = an) {
      let r = t.gl,
        c,
        u = vs.replace("{{user}}", e != null ? e : on),
        s = Es.replace("{{user}}", n != null ? n : an),
      ...
      if (
        ...
        r.compileShader(o),
        r.compileShader(d),
        (c = r.getShaderInfoLog(o)))
      )
        throw new Error(c);
      if ((c = r.getShaderInfoLog(d))) throw new Error(c);
...
`)
    ...
    function jr(e, n, r, c) {
      let u = e.width / n,
        ...
        h = {},
        m = c.split("").entries();
      for (let [g, y] of m) h[y] = f((g % u) * o, Math.floor(g / u) * d);
      return { tex: e, map: h, qw: o, qh: d };
    }
    a(jr, "makeFont");
    function St(e, n, r, c = l.defTex, u = l.defShader, s = {}) {
      (c = c != null ? c : l.defTex),
        (u = u != null ? u : l.defShader),
        (c !== l.curTex ||
          u !== l.curShader ||
          !Yt(l.curUniform, s) ||
    ...
    function pe(e) {
      ...
      let n = e.width,
        r = e.height,
        u = $e(e.origin || je).scale(f(n, r).scale(-0.5)),
      ...
      if (e.tiled) {
        ...
        for (let g = 0; g < o; g++)
          for (let y = 0; y < d; y++)
            pe(
              D(P({}, e), {
                pos: (e.pos || f(0)).add(f(r * g, c * y)).sub(m),
                scale: u.scale(e.scale || f(1)),
                tex: e.tex,
                quad: n,
                width: r,
                height: c,
        ...
        e.width && e.height
          ? ((u.x = e.width / r), (u.y = e.height / c))
          : e.width
          ? ((u.x = e.width / r), (u.y = u.x))
          : e.height && ((u.y = e.height / c), (u.x = u.y)),
          pe(
            D(P({}, e), {
              scale: u.scale(e.scale || f(1)),
              tex: e.tex,
    ...
    function We(e) {
      ...
      let c = e.width || 1,
        u = r
          ...
          .normal()
          .scale(c * 0.5),
        s = [n.sub(u), n.add(u), r.add(u), r.sub(u)].map((o) => {
          var d, h;
          return {
            pos: ce(o.x, o.y, 0),
            uv: f(0),
    ...
    function Ze(e) {
      ...
      if (!(n < 3)) {
        if (
          (re(), I(e.pos), ne(e.scale), Qe(e.angle), I(e.offset), e.fill !== !1)
        ) {
          let u = (r = e.color) != null ? r : v.WHITE,
            s = e.pts.map((d) => {
              var h;
              return {
                pos: ce(d.x, d.y, 0),
    ...
    function Xr(e) {
      let n = {},
        r = e.replace(gn, "$1"),
        c = 0;
      for (let u of e.matchAll(gn)) {
        let s = u.groups.style.split("."),
          o = u.index - c;
    ...
    function me(e) {
      ...
      let n = Un((Zn = e.font) != null ? Zn : i.font, U.fonts, xs);
      if (!n) throw new Error(`Font not found: ${e.font}`);
      let { charStyleMap: r, text: c } = Xr(e.text + ""),
        u = c.split(""),
        s = n.qw * n.tex.width,
        o = n.qh * n.tex.height,
        d = e.size || o,
...
`
          ...
          : (e.width ? y + m > e.width : !1) &&
            ...
            (y = 0),
            ee != null &&
              ((te -= M.length - ee), (oe = u[te]), (M = M.slice(0, ee))),
            (ee = null),
            O.push(M),
            (M = [])),
          oe !==
...
` && (M.push(oe), (y += m), oe === " " && (ee = M.length)),
        ...
        O.forEach((oe, Bi) => {
          ...
          oe.forEach((lt, ji) => {
            ...
            if (_t) {
              ...
              if (r[ct]) {
                let { styles: ht, localIdx: Xi } = r[ct];
                for (let Ki of ht) {
                  let Nt = e.styles[Ki],
                    rr = typeof Nt == "function" ? Nt(Xi, lt) : Nt;
                  rr && wn(Bt, rr);
                }
              }
              Ae.push(Bt);
    ...
    a(G, "height"),
      ...
      t.canvas.addEventListener("keydown", (e) => {
        ...
        ms.includes(n) && e.preventDefault(),
    ...
    a(Z, "dt");
    function Qr() {
      return j("mouseWorldPos()", "toWorld(mousePos())"), qt(K());
    }
    a(Qr, "mouseWorldPos");
    function Zr(e, n) {
      e.forEach((r, c) => {
    ...
    a(Sn, "onDraw");
    function Cn(e, n, r) {
      let c = qe("collide", e, (o, d, h) => d.is(n) && r(o, d, h)),
        u = qe("collide", n, (o, d, h) => d.is(e) && r(d, o, h)),
        s = Pe(e, (o) => {
          if (!o.area)
            throw new Error(
          ...
          if (
            ...
            p.root.every((h) => {
              ...
              for (let _ in Ae) {
                let se = Ae[_];
                if (
                  (c === 0 && se.p1.x === 0 && se.p2.x === 0) ||
                  (u === 0 && se.p1.y === 0 && se.p2.y === 0)
                ) {
                  x = 1;
                  break;
                }
    ...
    function Vt(e = {}) {
      ...
      return {
        ...
        isOutOfView() {
          var s;
          let c = f((s = e.offset) != null ? s : 0),
            u = new Be(f(0, 0).sub(c), f(F(), G()).add(c));
          return !gt(this.screenArea(), u);
        },
        onExitView(c) {
    ...
    function fi(e = {}) {
      return typeof e == "number"
        ? (j("clean(time)", "cleanup({ delay: time })"),
    ...
    function pi(e = {}) {
      ...
      return {
        ...
        isHovering() {
          let u = this.fixed ? K() : qt(K());
          return this.hasPoint(u);
        },
        isColliding(u) {
          if (!u.area || !u.exists()) return !1;
        ...
        onCollide(u, s) {
          let o = this.onUpdate(() => this._checkCollisions(u, s)),
            d = this.on("collide", (h, m) => h.is(u) && s(h, m));
        ...
        hasPoint(u) {
          return Ut(this.worldArea(), u);
        },
        pushOut(u) {
          var g;
          if (
            u === this ||
            ((g = u.area) == null ? void 0 : g.shape) !== "rect"
          )
            return null;
          let s = this.worldArea(),
            o = u.worldArea(),
        ...
        worldArea() {
          var m, g, y, x;
          let u = (m = this.area.width) != null ? m : this.width,
          ...
          let d = $e(this.origin || je),
            h = ((x = this.pos) != null ? x : f(0))
              ...
              .sub(d.add(1, 1).scale(0.5).scale(u, s));
          return { shape: "rect", p1: h, p2: f(h.x + u, h.y + s) };
        },
        screenArea() {
          let u = this.worldArea();
          return this.fixed ? u : { shape: "rect", p1: it(u.p1), p2: it(u.p2) };
        },
      };
    }
    a(pi, "area");
    ...
    function mi(e, n = {}) {
      function r(c) {
        ...
        return (
          (c.width = u.width / (((s = c.scale) == null ? void 0 : s.x) || 1)),
          (c.height = u.height / (((o = c.scale) == null ? void 0 : o.y) || 1)),
          u
        );
      }
      return (
    ...
    function vi(e = {}) {
      ...
      return {
        ...
        update() {
          ...
          if (r) {
            ...
            !r.exists() || x !== W || M < ee || O > te
              ? (this.trigger("fall", r), (r = null), (c = null), (h = !0))
              : c &&
                r.pos &&
                ((this.pos = this.pos.add(r.pos.sub(c))), (c = r.pos.clone()));
          }
          if (!r) {
            let g = this.move(0, n);
            if (g)
        ...
        doubleJump(h) {
          this.isGrounded()
            ? this.jump(h)
            : u && ((u = !1), this.jump(h), this.trigger("doubleJump"));
        },
        onGround(h) {
    ...
    function $n(e = 2, n = 1) {
      ...
      return {
        ...
        update() {
          ...
          c < 0 && ut(this), (this.scale = f(c)), (r += Z());
        },
      };
    }
    a($n, "explode");
    ...
    function Jn() {
      ...
      if (C.inspect) {
        let r = null,
          c = v.fromArray((e = i.inspectColor) != null ? e : [0, 0, 255]);
        if (
          (p.root.every((u) => {
            if (!u.area || u.hidden) return;
            r || (u.isHovering() && (r = u));
            let s = r === u ? 8 : 4,
              o = u.worldArea(),
              d = o.p2.x - o.p1.x,
          ...
          let u = [],
            s = r.inspect();
          for (let o in s) s[o] ? u.push(`${o}: ${s[o]}`) : u.push(`${o}`);
          zn(
            K(),
            u.join(`
`)
      ...
      if (C.timeScale !== 1) {
        ...
        for (let u = 0; u < 2; u++) {
          let s = C.timeScale < 1;
          pn({
            p1: f(-c.width - r * (s ? 2 : 3.5), -r),
            p2: f(-c.width - r * (s ? 2 : 3.5), -r - c.height),
            p3: f(-c.width - r * (s ? 3.5 : 2), -r - c.height / 2),
            pos: f(-u * r * 1 + (s ? -r * 0.5 : 0), 0),
            color: E(255, 255, 255),
            fixed: !0,
          });
        }
    ...
    function Qn(e) {
      let n = a((r) => {
        ...
        let c = r / 1e3,
          u = c - t.realTime;
        (t.realTime = c),
          t.skipTime || ((t.dt = u), (t.time += t.dt), t.fpsCounter.tick(t.dt)),
          (t.skipTime = !1),
          t.numFrames++,
          e();
